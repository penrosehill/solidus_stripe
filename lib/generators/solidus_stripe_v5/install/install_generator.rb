  ...
  module Generators
    class InstallGenerator < Rails::Generators::Base
      ...
      def install_migrations
        ...
        shell.indent do
          rake 'railties:install:migrations FROM=solidus_stripe_v5'
      ...
      def install_solidus_core_support
        support_code_for(:core) do
          ...
          route "mount SolidusStripeV5::Engine, at: '#{solidus_mount_point}solidus_stripe_v5'"
        end
      end
      ...
      def install_solidus_backend_support
        support_code_for(:backend) do
          append_file(
            ...
            "//= require spree/backend/solidus_stripe_v5\n"
          )
          inject_into_file(
      ...
      def install_solidus_starter_frontend_support
        support_code_for(:starter_frontend) do
          ...
          inject_into_file(
            ...
            " *= require spree/frontend/solidus_stripe_v5\n",
            before: %r{\*/},
            verbose: true,
          )
      ...
      def watch
        ...
        glob = "#{::SolidusStripeV5::Engine.root}/{app,lib,config}"
