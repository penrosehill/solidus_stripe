...
require "solidus_stripe_v5/money_to_stripe_amount_converter"
...
module SolidusStripeV5
  ...
  #
  # The `Spree::RefundReason` with `SolidusStripeV5::Config.refund_reason_name`
  ...
  class RefundsSynchronizer
    ...
    def create_refund(payment, stripe_refund)
      Spree::Refund.create!(
        ...
        reason: SolidusStripeV5::PaymentMethod.refund_reason
