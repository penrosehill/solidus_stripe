    ...
    class Event
      ...
      class << self
        def from_request(payload:, signature_header:, slug:, tolerance: default_tolerance)
          payment_method = SolidusStripeV5::PaymentMethod.with_slug(slug).first!
        ...
        def default_tolerance
          SolidusStripeV5.configuration.webhook_signature_tolerance
        end
      end
      ...
      # @attr_reader [SolidusStripeV5::PaymentMethod]
