...
FactoryBot.define do
  factory :solidus_stripe_payment_method, class: 'SolidusStripeV5::PaymentMethod' do
    type { "SolidusStripeV5::PaymentMethod" }
  ...
  factory :solidus_stripe_payment_source, class: 'SolidusStripeV5::PaymentSource' do
  ...
  factory :solidus_stripe_payment_intent, class: 'SolidusStripeV5::PaymentIntent' do
    association :order
    association :payment_method, factory: :solidus_stripe_payment_method
    stripe_intent_id { "pm_#{SecureRandom.uuid.delete('-')}" }
  end

  factory :solidus_stripe_slug_entry, class: 'SolidusStripeV5::SlugEntry' do
    association :payment_method, factory: :solidus_stripe_payment_method
    slug { SecureRandom.hex(16) }
  end

  factory :solidus_stripe_customer, class: 'SolidusStripeV5::Customer' do
    association :payment_method, factory: :solidus_stripe_payment_method
  ...
  factory :solidus_stripe_payment_log_entry, class: 'Spree::LogEntry' do
    ...
    details {
      YAML.safe_dump(
        SolidusStripeV5::LogEntries.build_payment_log(
          success: success,
          message: message,
