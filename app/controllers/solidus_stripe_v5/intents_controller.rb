...
class SolidusStripeV5::IntentsController < Spree::BaseController
  ...
  def after_confirmation
    ...
    intent = SolidusStripeV5::PaymentIntent.find_by!(
  ...
  def load_payment_method
    @payment_method = current_order(create_order_if_necessary: true)
      ...
      .merge(SolidusStripeV5::PaymentMethod.with_slug(params[:slug]))
      .first!
  end
end
