...
module SolidusStripeV5
  class PaymentMethod < ::Spree::PaymentMethod
    ...
    has_one :slug_entry, class_name: 'SolidusStripeV5::SlugEntry', inverse_of: :payment_method, dependent: :destroy
    ...
    # @see SolidusStripeV5::Configuration.refund_reason_name
    def self.refund_reason
      Spree::RefundReason.find_by!(
        name: SolidusStripeV5.configuration.refund_reason_name
      )
    end
    ...
    def self.intent_id_for_payment(payment)
      ...
      payment.transaction_id || SolidusStripeV5::PaymentIntent.where(
