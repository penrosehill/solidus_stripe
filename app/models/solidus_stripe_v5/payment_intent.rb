...
module SolidusStripeV5
  class PaymentIntent < ApplicationRecord
    self.table_name = "solidus_stripe_payment_intents"
    ...
    def process_payment
      ...
      SolidusStripeV5::LogEntries.payment_log(
        payment,
        success: successful,
        message: I18n.t("solidus_stripe_v5.intent_status.#{stripe_intent.status}"),
        data: stripe_intent,
      )
    ...
    def create_stripe_intent(payment, **stripe_intent_options)
      stripe_customer_id = SolidusStripeV5::Customer.retrieve_or_create_stripe_customer_id(
        payment_method: payment_method,
        order: order
      )
