...
RSpec.describe SolidusStripeV5::WebhooksController, type: %i[request webhook_request] do
  describe "POST /create charge.refunded" do
    it "synchronizes refunds" do
      ...
      context = SolidusStripeV5::Webhook::EventWithContextFactory.from_object(
        payment_method: payment_method,
