...
RSpec.describe SolidusStripeV5::Webhook::Event do
  ...
  describe ".from_request" do
    let(:context) do
      SolidusStripeV5::Webhook::EventWithContextFactory.from_data(
        data: SolidusStripeV5::Webhook::DataFixtures.charge_succeeded,
  ...
  describe "#initialize" do
    let(:context) do
      SolidusStripeV5::Webhook::EventWithContextFactory.new(
        data: SolidusStripeV5::Webhook::DataFixtures.charge_succeeded,
        payment_method: create(:solidus_stripe_payment_method)
      )
    end
